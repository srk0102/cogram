...
class GraphOperationsInterface(BaseModel):
    ...
    Type reference:
        - driver: GraphDriver
        - EntityNode, EpisodicNode, CommunityNode, SagaNode from cogram.core.nodes
        - EntityEdge, EpisodicEdge, CommunityEdge from cogram.core.edges
        - EpisodeType from cogram.core.nodes
    """
